...
public class ConexionBD 
{
    ...
    /* inicializarEstructura
     * Metodo que se encarga de la creacion de la base de datos y demás tablas.
     */
    private void inicializarEstructura() throws SQLException
    {
        ArrayList<String> instrucciones;
        Lectura objeto = new Lectura("fichero.sql");
        
        
        try {
           instrucciones = objeto.getDatos();
           
           
           for(int i=0; i<instrucciones.size(); i++)           
            this.IUD(instrucciones.get(i));
            
       //-------------------------------------------------------
            
           // System.out.println("Terminada de inicializar!");
